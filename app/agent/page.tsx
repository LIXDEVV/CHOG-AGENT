...
export default function AgentPage() {
  ...
  const analyzeToken = async (pairData: any) => {
    try {
      ...
      clearDialogues()
      addThinkingDialogue("Analyzing with CHOG...")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-purple-900 to-purple-950">
      ...
      <div className="relative z-10 flex h-screen flex-col">
        ...
        <div className="flex-shrink-0 border-b border-purple-800/50 bg-purple-950/50 backdrop-blur-sm flex flex-col gap-2 p-3">
          <div>
            <Button
              onClick={() => router.push("/")}
              variant="ghost"
              className="text-fuchsia-400 hover:bg-fuchsia-500/10 text-sm"
            >
              ← Back to Home
            </Button>
          </div>
        ...
        <div className="flex flex-1 min-h-0 gap-2 p-2">
          ...
          <div className="w-2/5 flex flex-col gap-2 min-h-0">
            ...
            <div className="flex-shrink-0 h-80 rounded-2xl border border-purple-800/30 bg-gradient-to-br from-purple-900/40 to-purple-900/20 flex items-center justify-center p-2 overflow-hidden">
              <PepeAgent
            ...
            <div className="flex-1 min-h-0 rounded-2xl border border-purple-800/30 bg-gradient-to-br from-purple-900/20 to-purple-900/10 p-3 overflow-hidden flex flex-col">
              <h3 className="text-xs font-bold text-fuchsia-400 mb-2 uppercase tracking-widest flex-shrink-0">
                Analysis Factors
              </h3>
          ...
          <div className="w-3/5 flex flex-col min-h-0">
            <div className="flex-1 rounded-2xl border border-purple-800/30 bg-gradient-to-br from-purple-900/20 to-purple-900/10 overflow-hidden">
              {chartReady && pairAddress ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-purple-300">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-purple-400">CHOG will analyze it for you</p>
                  </div>
                </div>
              )}
            </div>
